...
public class WorldRenderer {
    ...
    public void render() {
        ...
        font24.draw(batch, "Player: " + gc.getUnitController().getHero().getName()
                             + ", coins: " + gc.getUnitController().getHero().getCoins(), 20, 680);
        font24.draw(batch, "Round: " + gc.getUnitController().getRound(), 20, 710);
        batch.end();
    }
}
